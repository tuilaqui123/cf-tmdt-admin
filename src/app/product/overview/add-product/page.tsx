...
const AddProduct = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (!categoryName) {
      alert("Yêu cầu chọn loại sản phẩm");
      return;
    }
    if (!des) {
    ...
    if (!image) {
      alert("Yêu cầu thêm hình ảnh cho sản phẩm");
      return;
    }
    if (type.length === 0) {
      alert("Yêu cầu các type cho sản phẩm");
      return;
    }
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <form action="#">
            <div className="p-6.5">
              ...
              <SelectCategoryOption onCategoryChange={handleCategoryChange} />
